...
d1: stack(
  ...
  "[t t t t]*4".s("nhh:0").legato(nrand(0.125,0.375,739)).gain(0.5).nbpf(perlin.slows(3,991).rangex(1,10000),1,perlin.slows(3,668).range(1,10000)),
...
d2: stack(
  ...
  .nbpf(perlin.slows(3,737).rangex(1,10000),1,perlin.slows(3,294).range(1,10000))
  ,
