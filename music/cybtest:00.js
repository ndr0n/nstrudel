...
let nh = "[t*[<[2|4|8|16]>/3]]"
d1:stack(
s("ncircuit:9").loopAt(8).randslice(16).fast(16).late(16).degradeBy(0.7).clip(irand(4).add(1)).cut(1)
.gain(1/3).lpf(3000).lpq(6)
.slowf(2,x=>x.repeatCycles(4))
,
stack(
s("namen:12").loopAt(4).randslice(16).fast(16).late(32).degradeBy(0.7).clip(irand(2).add(1)).cut(1).gain(0.2),
