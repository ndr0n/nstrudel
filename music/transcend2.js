...
d1:stack(
stack(
s("supersaw").slow(irand(9)).detune(1/12).note(31).trans(0).trans("[0,7]").gain(1).clip(1).cut(22)
...
,
stack(
s("namen:1").loopAt(0.5).randslice(8).fast(8).degradeBy(1/3).gain(1/3).clip("[0.25|1]*32").cut(3)
.coarse(irand(9))
