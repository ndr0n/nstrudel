...
,
stack(
s("namen:3").loopAt("[1|2|2]").randslice(16).fast(8).degradeBy(1/9).late(238).gain(1/3).clip("[1|0.5|1|0.25|1]*32").cut(3)
...
.sometimesBy(1/3,x=>x.cps(rand.early(237).range(0.25,0.75)))
,
