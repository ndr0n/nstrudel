...
,
stack(
s("namen:3").loopAt("[2]").randslice(16).fast(16).degradeBy(1/3).late(238).gain(1/3).clip(wchoose([1,1],[0.25,0.5])).cut(2)
.ndjf(perlin.slow(3).late(583).range(0.05,0.35)).ndjfq(0.1)
,
stack(
