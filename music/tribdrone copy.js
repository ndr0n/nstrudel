...
ns.s("ns:29").clip(0.5).gain(0.3).cut(1).ndjf(perlin.slow(5).range(0.1,0.9)),
"t*[1|2|4|8|8?|16|16?]".s("nhh:0").clip(rand.late(753).range(0.125,0.375)).gain(0.2),
).orbit(1)
.nbpf(perlin.slow(3).range(300,3000),9,6000)
.delay(0.25).delayt("1".div(perlin.range(60,90))).delayfb(rand.range(0.1,0.9))
,
stack(
nk.s("saw").note(24).clip(8).gain(0.3)
.gain(1).nmod(nlfo(1).naddnote("[12|19|24|31|36]"))
.ndjf(0.1).nmod(nenv(0.1).natt(1).nsync(1)).cut(2).ndjfq(0.2)
,
s("supersaw").detune(1/16).note("[0|2|3|5]").fast(16).degradeBy(0.25).trans(24).gain(0.25)
// .gain(1).nmod(nlfo(0.25).naddnote(19).ntype('sine'))
.slowf(2,x=>x.repeatCycles(4))
.lpf(30).lpe(rand.range(-3,6).late(231)).lpq(9).lps(perlin.slow(7).range(0,0.5)).lpd(rand.late(371))
.nbpf(perlin.slow(3).range(300,3000),9,6000)
,
s("ncircuit:12").loopAt(2).randslice(16).fast(8).degradeBy(0.7).late(249).clip(1).cut(9)
.gain(0.125).bpf(perlin.rangex(90,900)).bpq(0.25)
,
